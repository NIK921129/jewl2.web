...
if (!process.env.JWT_SECRET) console.warn("⚠️  JWT_SECRET is not set — using an insecure default.");
if (!process.env.ADMIN_PASSWORD) console.warn("⚠️  ADMIN_PASSWORD is not set — using an insecure default.");
